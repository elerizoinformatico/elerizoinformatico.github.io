...
Para este tipo de ecuaciones podemos **factorizar**, **completar cuadrados** o utilizar la **fórmula general** de resolución. Esta última la veremos más adelante en detalle.
